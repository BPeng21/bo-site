  ...
  return (
    <article className={clsx('hobby-content', wheelStatus)}>
      ...
      {hobbiesInfo[hobbyIndex]?.image && (
        <img
          src={hobbiesInfo[hobbyIndex].image}
          alt={hobbiesInfo[hobbyIndex].title}
          className={`${hobbiesInfo[hobbyIndex].id}-img`}
        />
      )}

      {
        wheelStatus === 'spinning' && <span className="spinner"></span>
